...
@Singleton
class ListPartnerIncomeConnector @Inject() (val http: HttpClientV2, val appConfig: AppConfig) extends BaseDownstreamConnector {

  def listPartnerIncome(request: ListPartnerIncomeRequestData)(implicit
      hc: HeaderCarrier,
      ec: ExecutionContext,
      correlationId: String
  ): Future[DownstreamOutcome[ListPartnerIncomeResponse]] = {
