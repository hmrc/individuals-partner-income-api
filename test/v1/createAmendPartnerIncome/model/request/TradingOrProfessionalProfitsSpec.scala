...
class TradingOrProfessionalProfitsSpec extends UnitSpec {
  ...
  private val model = TradingOrProfessionalProfits(
    shareOfProfitOrLoss = 5000.99,
  ...
  "reads" should {
    "read from json" in {
      json.as[TradingOrProfessionalProfits] shouldBe model
    }
  }
