...
class TaxedIncomeAndDividendIncomeSpec extends UnitSpec {
  ...
  private val model = TaxedIncomeAndDividendIncome(
  ...
  "reads" should {
    "read from json" in {
      json.as[TaxedIncomeAndDividendIncome] shouldBe model
    }
  }
